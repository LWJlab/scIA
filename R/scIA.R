...
#' @param ci_gs List of marker genes' confidence
#' @param wt_gs List of marker genes' weight
...
scIA <- function(object, 
  ...
  # 步骤2: 过滤排除的细胞类型
  message("\n[1/5] Filtering excluded cell types...")
  if (!is.null(ex_types)) {
  ...
  message("\n[2/5] Calculating pan-celltype scores...")
  if (is.null(org)) {
  ...
  # 步骤5: 对每个大类/混合类单独进行预测
  message("\n[4/5] Performing cell type prediction for each group...")
  ...
  # 步骤6: 整合所有结果
  message("\n[5/5] Merging results and creating final output...")
